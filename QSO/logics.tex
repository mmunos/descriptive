...
We extend $\qfo$ with the operator $[\textbf{alfp}_{\varphi(y_1,\ldots,y_k,R)}\alpha(x_1,\ldots,x_{\ell},R,\pi)](x_1,\ldots,x_{\ell})$. It is defined by a FO-formula $\varphi$ and a QFO-formula $\alpha$ which mentions a placeholder function $\pi$ with domain $\fv^{\ell}$. 
