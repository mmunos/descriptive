...
\martin{comment about unordered structures}
...
\martin{comentario "this explantion that \#L (when L is LFP or TC) can express some \#P-complete problems seems out of
	place when you have already mentioned (just before Prop. IV.2) that \#FO captures all of \#P."}
...
\end{theorem}
\martin{rewrite two following paragraphs}
