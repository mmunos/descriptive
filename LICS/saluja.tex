Saluja et. al \cite{DBLP:journals/jcss/SalujaST95} define a family of counting classes $\#\LL$ for each fragment $\LL$ of $\fo$. For a formula $\varphi(x,X)$, the function $f_{\varphi(x,X)}$ is defined as
\[
