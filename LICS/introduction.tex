...
By adding variables for functions in top of $\qso$, we introduce a quantitative least fixed point operator to the logic. 
...
Due to the lack of space, the complete proofs of the results of the paper can be found in a separate appendix that can be downloaded from \verb+http://marenas.sitios.ing.uc.cl/ls17.pdf+
