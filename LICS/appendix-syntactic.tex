...
$$
Phi = p \wedge \bigwedge_{i = 1}^n (t_i \vee p \to q) \wedge \neg q,
$$
...
$$
Phi' = p \wedge \bigwedge_{i = 1}^{\ell-1} (t_i \vee p \to q) \wedge (p\to q) \wedge \bigwedge_{i = \ell+1}^{n} (t_i \vee p \to q) \wedge \neg q,
$$
