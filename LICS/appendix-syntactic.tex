...
The previous claim motivates the following definitions, in particular, a generalization of the sequence $\bar{B}$. 
...
Indeed, one can define a formula $\mu_i$ that defines $v^*$ as follows:
$$
