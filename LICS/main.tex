...
\title{Descriptive Complexity \\
	for Complexity Classes of Functions}
...
Unfortunately, descriptive complexity for function complexity classes (e.g. $\fp$ and $\shp$) has not been systematically studied, and it is not as developed as for the case of decision problems.
