...
\martin{Sugerencia:
	...
	we define $\logex{1}$ as $\Sigma_1$ but allowing arbitrary quantifiers in sub-formulas that have only first-order variables. [Tal vez agregar un ejemplo para que se entienda de donde viene el [FO] ]}
