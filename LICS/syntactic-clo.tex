...
\martin{Sugerencia:
	...
	we define $\logex{1}$ as $\Sigma_1$ but allowing arbitrary quantifiers in sub-formulas that have only first-order variables. This is, atomic formulae include arbitrary first-order formulae. [Tal vez incluir un ejemplo] }
