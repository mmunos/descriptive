...
In this paper we only consider finite ordered structures, so we will usually omit the word finite or ordered when referring to them.
...
We consider several counting complexity classes in this paper, some of the are recalled here~(see \cite{F97,hemaspaandra2013complexity}).
