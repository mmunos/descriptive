...
$\totp$ is an interesting counting complexity class as it naturally defiortnownes a class of functions in $\shp$ with easy decision counterparts. However, we do not have a logical characterization of this class.
