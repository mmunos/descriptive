...
\keywords{Function complexity classes, descriptive complexity}
\ACMCCS{
[{\bf Theory of computation}]:~Logic---Finite Model Theory
[{\bf Theory of computation}]:~Computational complexity and cryptography---Complexity classes}
...
\subsection{Extending $\qso$ to capture classes beyond counting} \label{sec:extentions}
\input{extentions}
