...
%extend our previous counting function to the case of arbitrary directed graphs. 
...
%\footnote{Recall that in this paper we consider ordered $\R$-structures.} 
...
\qed
\end{exa}
\martin{El Reviewer 1 hizo un comentario de este ejemplo, lo respond\'i en la carta}
\marcelo{Me parece bien la respuesta en la carta. Agregue esta respuesta en el paper, ayuda a entender mejor el ejemplo.}
