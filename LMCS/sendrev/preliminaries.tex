...
$\fp$ is the class of functions $f \colon \Sigma^* \to \N$ computable in polynomial time, while $\fpspace$ is the class of functions $f \colon \Sigma^* \to \N$ computable in polynomial space. 
