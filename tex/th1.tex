...
\end{proof}
Clearly $g \in\#\Sigma_0$. As we showed, computing $g$ is enough to solve the decision version of $f$. Therefore, given that any counting problem in $\#\Sigma_0$ is computable in polynomial time \cite{DBLP:journals/jcss/SalujaST95}, we conclude that the decision version of $f$ is in {\sc P}.
\end{proof}